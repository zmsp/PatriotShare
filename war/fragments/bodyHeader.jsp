          ...
          <div id="navbar" class="navbar-collapse collapse">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                  ...
                  <li><a href="/jsp/userProfile.jsp"><%out.print(user.getProperty("firstName") + " " + user.getProperty("lastName"));%></a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
              <!--<li style="background-color:#CCC66C" active><a href="./">Sign up <span class="sr-only">(current)</span></a></li>-->
              <li style="background-color:#CCC66C" active><a href="<%=request.getContextPath()%>/logout">Log out<span class="sr-only">(current)</span></a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div><!--/.container-fluid -->
      </div>
